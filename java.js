...
var p=pq[Math.floor(Math.random()*3)];
 ...
 var hello=["HELLO","HI", "HELLO ","HEY THERE","HEY","HI DUDE","HI "];
 var gm=["GM","GOOD MORNING","GOOD MORNING", "GOOD MORNING "];
 var bad=["BAD","NOT BAD","USELESS","NOT WORKING","NOT GOOD"];
 var ge=["GOOD EVNG","GOOD EVENING","GOOD EVENING ","GOOD EVENING"];
 ...
 var gaf=["GOOD AFTERNOON","GOOD AFTERNOON ","GOOD AFTERNOON " ];
 var ly=["NO YOU ARE LYING", "NO YOU ARE LIAR","NO", "NO YOU ARE WRONG"];
 var like=["GOOD","????", "??","??","LOL","ME TOO","YES","YEAH","YUPS"];
 var hru=["HOW R U?","H R U?", "HOW ARE YOU?", "HRU?","HRU", "HOW R U","H R U", "HOW ARE YOU"];
 var good=["I'M GOOD","I'M FINE","I AM FINE AND YOU", "I'M FINE AND YOU", "I'M FINE U", "I AM FINE","I'M FINE AND HOW ARE YOU", "MEE TOO", "FINE","FINE:)","FINE :)", "MARVELOUS","AWESOME","FINE??","GREAT"];
 var yes=["REALLY",""]
...
isInArray(wru, lastmsg)==true?(smsg="I am jarvis", k=smsg):
...
(smsg="Sorry, I have no answer for that. If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search WhatsApp</b>",k="Sorry, I have no answer for that. ");
